...
namespace BT.Editor.Generated.Nodes
{
    ...
    class BTProbability : Node, IBTRuntimeJsonNode
    {
        ...
        public string RuntimeTypeId => "BT.BTProbability";
        ...
        public List<BTArgJson> CollectArgs()
        {
            ...
            {
                new BTArgJson { name = "Probability", type = BTArgType.Int, value = Probability.ToString(CultureInfo.InvariantCulture) },
            };
        }
    }
}
